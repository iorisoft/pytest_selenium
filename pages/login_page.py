...
class LoginPage(BasePage):
    email_address_input = (By.ID, "input-email")
    ...
    def set_email_address(self,email_address):
        self.set(self.email_address_input, email_address)
        #self.driver.find_element(email_address_input).send_keys(email_address)
